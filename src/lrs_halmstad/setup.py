...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'camera_tracker = lrs_halmstad.camera_tracker:main',
            'follow_uav = lrs_halmstad.follow_uav:main',
            'follow_uav_odom = lrs_halmstad.follow_uav_odom:main',
            "leader_detector = lrs_halmstad.leader_detector:main",
            "leader_tracker = lrs_halmstad.leader_tracker:main",
